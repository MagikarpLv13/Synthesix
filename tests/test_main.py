...
class InvestigationPageRoutingTestCase(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_external_page_overlay_returns_save_action(self):
        ...
        self.assertIn("data-synthesix-collapse", tab.script)
        self.assertIn("Collapse Synthesix overlay", tab.script)
        self.assertIn("Expand Synthesix overlay", tab.script)
        self.assertIn("overlayCollapsed", tab.script)
