(function () {
    ...
    const french = {
        ...
        "A search is already running. Cancel it or wait for it to finish.": "Une recherche est déjà en cours. Annulez-la ou attendez qu'elle se termine.",
        "No search is currently running.": "Aucune recherche n'est en cours.",
        "History": "Historique",
        "Settings": "Paramètres",
        "Language": "Langue",
        "Theme": "Thème",
    ...
    const multilingual = {
        ...
        "No saved searches yet": ["Aucune recherche enregistrée pour l'instant","Aún no hay búsquedas guardadas","暂无已保存的搜索"],
        "Run a search from the home page to build your history.": ["Lancez une recherche depuis la page d'accueil pour constituer votre historique.","Ejecuta una búsqueda desde la página de inicio para crear tu historial.","在主页发起搜索即可建立历史记录。"],
        "Search scope": ["Portée de la recherche","Alcance de la búsqueda","搜索范围"],
        "Scope": ["Portée","Alcance","范围"],
        "Investigation next actions": ["Prochaines actions de l'enquête","Próximas acciones de la investigación","调查的后续操作"],
        "pages to review": ["pages à examiner","páginas por revisar","待审查页面"],
        "monitored changes": ["changements surveillés","cambios monitorizados","受监控的变更"],
        "proposed entities": ["entités proposées","entidades propuestas","建议的实体"],
        "captures": ["captures","capturas","捕获"],
        "Triage saved pages before exporting.": ["Triez les pages enregistrées avant l'export.","Clasifica las páginas guardadas antes de exportar.","导出前先对已保存页面进行筛选。"],
        "Open changed pages and compare archives.": ["Ouvrez les pages modifiées et comparez les archives.","Abre las páginas modificadas y compara los archivos.","打开已变更的页面并比较存档。"],
        "Validate or attach extracted identifiers.": ["Validez ou rattachez les identifiants extraits.","Valida o adjunta los identificadores extraídos.","验证或附加已提取的标识符。"],
        "Evidence files attached to saved pages.": ["Fichiers de preuve attachés aux pages enregistrées.","Archivos de evidencia adjuntos a las páginas guardadas.","附加到已保存页面的证据文件。"],
        ...
        "Cancel search": ["Annuler la recherche","Cancelar la búsqueda","取消搜索"],
        "Search in progress...": ["Recherche en cours...","Búsqueda en curso...","搜索进行中..."],
        "Search cancelled.": ["Recherche annulée.","Búsqueda cancelada.","搜索已取消。"],
        "A search is already running. Cancel it or wait for it to finish.": ["Une recherche est déjà en cours. Annulez-la ou attendez qu'elle se termine.","Ya hay una búsqueda en curso. Cancélala o espera a que termine.","已有搜索正在进行。请取消或等待其完成。"],
        "No search is currently running.": ["Aucune recherche n'est en cours.","No hay ninguna búsqueda en curso.","当前没有正在进行的搜索。"],
        ...
        "Grouping rules": ["Règles de regroupement","Reglas de agrupación","分组规则"],
        "Group saved pages by domain": ["Grouper les pages enregistrées par domaine","Agrupar páginas guardadas por dominio","按域名分组已保存的页面"],
        "Open Wayback Machine": ["Ouvrir Wayback Machine","Abrir Wayback Machine","打开 Wayback Machine"],
        "Remove from investigation": ["Retirer de l'enquête","Quitar de la investigación","从调查中移除"],
    ...
    const additionalTranslations = {
        ...
        "No saved searches yet": ["Ainda não há pesquisas guardadas", "Noch keine gespeicherten Suchen"],
        "Run a search from the home page to build your history.": ["Faça uma pesquisa na página inicial para criar o seu histórico.", "Starten Sie eine Suche auf der Startseite, um Ihren Verlauf aufzubauen."],
        "Search scope": ["Âmbito da pesquisa", "Suchumfang"],
        "Scope": ["Âmbito", "Umfang"],
        "Investigation next actions": ["Próximas ações da investigação", "Nächste Ermittlungsschritte"],
        "pages to review": ["páginas a rever", "zu prüfende Seiten"],
        "monitored changes": ["alterações monitorizadas", "überwachte Änderungen"],
        "proposed entities": ["entidades propostas", "vorgeschlagene Entitäten"],
        "captures": ["capturas", "Aufnahmen"],
        "Triage saved pages before exporting.": ["Triar as páginas guardadas antes de exportar.", "Gespeicherte Seiten vor dem Export sichten."],
        "Open changed pages and compare archives.": ["Abra as páginas alteradas e compare os arquivos.", "Geänderte Seiten öffnen und Archive vergleichen."],
        "Validate or attach extracted identifiers.": ["Valide ou anexe os identificadores extraídos.", "Extrahierte Bezeichner validieren oder anhängen."],
        "Evidence files attached to saved pages.": ["Ficheiros de prova anexados às páginas guardadas.", "An gespeicherte Seiten angehängte Beweisdateien."],
        ...
        "Cancel search": ["Cancelar a pesquisa", "Suche abbrechen"],
        "Search in progress...": ["Pesquisa em curso...", "Suche läuft..."],
        "Search cancelled.": ["Pesquisa cancelada.", "Suche abgebrochen."],
        "A search is already running. Cancel it or wait for it to finish.": ["Já existe uma pesquisa em curso. Cancele-a ou aguarde que termine.", "Es läuft bereits eine Suche. Brechen Sie sie ab oder warten Sie, bis sie beendet ist."],
        "No search is currently running.": ["Não há nenhuma pesquisa em curso.", "Es läuft derzeit keine Suche."],
        ...
        "Grouping rules": ["Regras de agrupamento", "Gruppierungsregeln"],
        "Group saved pages by domain": ["Agrupar páginas salvas por domínio", "Gespeicherte Seiten nach Domain gruppieren"],
        "Open Wayback Machine": ["Abrir Wayback Machine", "Wayback Machine öffnen"],
        "Remove from investigation": ["Remover da investigação", "Aus der Ermittlung entfernen"],
