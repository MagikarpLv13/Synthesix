...
## Corpus Check
- 100 files · ~111,516 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1645 nodes · 4228 edges · 81 communities (49 shown, 32 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 265 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3f6a2056`
...
Cohesion: 0.06
Nodes (45): Connection, EvidenceCapture, InvestigationError, InvestigationHasDataError, InvestigationNotFoundError, InvestigationResultNotFoundError, InvestigationValidationError, Raised when investigation input does not satisfy application rules. (+37 more)

### Community 2 - "Community 2"
Cohesion: 0.14
Nodes (8): _append_property_value(), _clean_text(), _default_property_key(), _extracted_property_key(), _extracted_property_value(), _normalize_tags(), _tagset_default_properties(), LocalSearchFilters
...
Cohesion: 0.06
Nodes (43): _challenge_excerpt(), _html_to_visible_text(), datetime, maybe_log_snapshot(), Process-wide counters for CDP traffic (T-006).  Categories used across the codeb, Log a rate summary at DEBUG level, at most once per ``interval``., _build_settings(), _env_bool() (+35 more)
...
Cohesion: 0.17
Nodes (6): fake_clock(), FakeElement, Patch ``time.monotonic`` and ``asyncio.sleep`` inside ``modules``.      Only the, Minimal DOM node double (truthy, clickable)., EngineWaitExampleTestCase, ProbeEngine
...
Cohesion: 0.19
Nodes (9): parse_with_xpath(), Parse generic search results from HTML using provided XPaths.     Args:, _build_country_index(), build_engine_region_params(), CountryRegion, _normalize_country_name(), resolve_country(), Offline parser golden tests.  To refresh a fixture after an engine changes: 1. R (+1 more)
...
Cohesion: 0.07
Nodes (15): _consume_home_tab_action(), _consume_page_tab_action(), _create_graph_entity_from_selection(), _install_and_consume_save_overlay(), _is_external_web_tab(), _overlay_bundle_script(), _push_home_tab_data(), Light per-tick probe: consume one queued action and report the data     version (+7 more)
...
Cohesion: 0.15
Nodes (30): AppSettings, EvidenceCaptureError, Raised when an evidence artifact cannot be captured or persisted., InvestigationService, _archive_page(), _archive_page_for_selection_source(), _artifact_file_path(), _cached_history_payload() (+22 more)

### Community 18 - "Community 18"
Cohesion: 0.11
Nodes (6): DuckDuckGoSearchEngine, _html_to_visible_text(), looks_like_duckduckgo_forbidden(), looks_like_duckduckgo_robot_challenge(), DuckDuckGoParsingTestCase, DuckDuckGoRobotChallengeErrorTestCase
...
Cohesion: 0.11
Nodes (15): apply_cli_runtime_overrides(), _apply_settings_to_tabs(), _attach_selection_to_graph_entity(), configure_event_loop_policy(), configure_logging(), _consume_settings_change(), _investigation_payload(), _log_level_from_args() (+7 more)

### Community 23 - "Community 23"
Cohesion: 0.09
Nodes (9): BraveSearchEngine, looks_like_brave_challenge_url(), looks_like_brave_robot_challenge(), _normalize_challenge_text(), Construct the query for the search., _create_brave_engine(), EngineGoldenParsingTestCase, BraveParsingTestCase (+1 more)

### Community 24 - "Community 24"
Cohesion: 0.40
Nodes (3): _overlay_injection_blocked(), Skip overlay injection on surfaces where it breaks or crashes Chrome.      Goo, OverlayInjectionGuardTestCase
...
Cohesion: 0.31
Nodes (3): GoogleRobotCheckTestCase, _GoogleRobotTab, T-004: captcha detection uses query_selector and the /sorry/ URL,     and an unr

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (10): BingSearchEngine, Resolve a Bing ``/ck/a`` redirect to the real destination URL.      Bing wraps, resolve_bing_redirect(), looks_like_duckduckgo_no_results(), True when DuckDuckGo explicitly reports an empty result set.      Used to stop w, _create_bing_engine(), BingPaginationTestCase, BingRedirectTestCase (+2 more)
...
Cohesion: 0.15
Nodes (23): Browser, _focus_or_open_home_tab(), _is_home_tab(), main(), _normalize_tab_url(), _open_or_refresh_investigation_page(), _open_tabs(), perform_search() (+15 more)
...
Cohesion: 0.20
Nodes (5): CallJournal, CallRecord, _FakeCookies, Fake Zendriver browser/tab harness shared by Synthesix tests (T-050).  Reference, Timestamped log of every fake call, shared browser <-> tabs.
...
Cohesion: 0.08
Nodes (22): ABC, BrowserSessionError, Base exception for application-level Synthesix failures., SearchEngineError, SynthesixError, Execute the search and return the results., Set the selector for the search engine.         Selector used as a reference poi, Construct the URL for the search. (+14 more)
...
Cohesion: 0.50
Nodes (4): _arm_overlay_focus_guard(), _overlay_focus_guard_script(), JS armed early (before any page script) so it wins the DOM event     ordering r, Register the focus-guard script for future navigations of ``tab``.      Best-e
...
Cohesion: 0.14
Nodes (5): GoogleSearchEngine, _create_google_engine(), SearchEngine, HangingTabEngine, Real SearchEngine subclass that opens a tab then hangs forever.      Exercises t
...
- **Why does `InvestigationRepository` connect `Community 1` to `Community 35`, `Community 5`, `Community 80`, `Community 17`, `Community 25`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `get_settings()` connect `Community 7` to `Community 35`, `Community 8`, `Community 11`, `Community 15`, `Community 17`, `Community 18`, `Community 25`, `Community 22`, `Community 23`, `Community 56`, `Community 57`, `Community 62`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `SearchOrchestrator` connect `Community 56` to `Community 35`, `Community 75`, `Community 11`, `Community 16`, `Community 17`, `Community 18`, `Community 23`, `Community 57`, `Community 28`, `Community 62`?**
...
- **What connects `Construct the query for the search.`, `Offline parser golden tests.  To refresh a fixture after an engine changes: 1. R`, `T-004: captcha detection uses query_selector and the /sorry/ URL,     and an unr` to the rest of the system?**
