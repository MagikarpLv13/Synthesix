...
| [T-011](T-011-recherche-non-bloquante.md) | Recherche non bloquante + annulation | P0 | Claude | done |
| [T-012](T-012-attente-moteurs-composite.md) | Attente moteurs par evaluate composite | P1 | Claude | done |
| [T-013](T-013-brave-fallback-parsing.md) | Parsing Brave : chaîne JSON → XPath | P1 | Codex | done |
| [T-014](T-014-pool-tabs-moteurs.md) | Pool de tabs moteurs + fin des vols de focus | P2 | Claude | done |
| [T-015](T-015-golden-files-parsing.md) | Golden files de parsing par moteur | P1 | Codex | done |
...
| [T-021](T-021-push-binding-pages-locales.md) | Push `Runtime.addBinding` pour pages locales | P1 | Claude | review |
| [T-022](T-022-decouverte-tabs-evenementielle.md) | Découverte de tabs par événements Target | P2 | Claude | review |
...
| ID | Titre | Priorité | Outil | Statut |
|---|---|---|---|---|
| [T-050](T-050-harness-faketab.md) | Harness FakeTab/FakeBrowser | P1 | Claude | done |
